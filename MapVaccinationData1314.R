...
KinderDataSub <- KinderDataSub[c(-37,-271),]
...
KVaccination <- KVaccination[,c(-2,-4,-5,-6,-9,-11,-13,-15,-17,-19,-21,-23,-25,-26,-28,-37,-38)]
...
VaccMap <- plotGoogleMaps(CCVaccination, zcol="Pct Personal Belief Exemptions", add=T, mapTypeId="HYBRID", colPalette=c("#91CF60","#F9F030","#FC5050"), at=c(0,0.03,0.1,1), layerName="Child Care Facilities 2013-14")
plotGoogleMaps(KVaccination, zcol="Pct Personal Belief Exemptions", previousMap=VaccMap, mapTypeId="HYBRID", colPalette=c("#91CF60","#F9F030","#FC5050"), at=c(0,0.03,0.1,1), layerName="Kindergartens 2013-14")
...
fileCon <- file("SacVaccination1314.htm")
